...
<div class=" container-fluid text-center"> <!--container que pone los botones de las cartas en el centro-->
      ...
      <div class="container-fluid d-flex justify-content-center row mt-3 "> <!--Te pone las tres cartas centradas d-flex justify-content-center-->
        <div class="card col-lg-6 border-0 polaroid">
          ...
          <img class="card-img-top " src="assets\img\imgTrabajo\futbol.jpg" alt="Dos niños disputando un balón en un partido de fútbol" style="width:100%">
        ...
        <div class="card col-lg-6 border-0 polaroid">
          ...
          <img class="card-img-top" src="assets\img\imgTrabajo\natacion1.jpg" alt="Niños esperando a saltar a la piscina en la escuela de verano" style="width:100%">
      ...
      <div class="card col-lg-6 border-0 polaroid  ">
          ...
          <img class="card-img-top" src="assets\img\imgTrabajo\defensapersonalhd.jpg" alt="Chica haciendo llave de defensa personal" style="width:100%">
          <div class="card-body">
        ...
        <div class="card col-lg-6 border-0 polaroid">
          ...
          <img class="card-img-top" src="assets\img\imgTrabajo\padel.jpg" alt="Entrega de premios en torneo de pádel" style="width:100%">
          <div class="card-body">
      ...
      <div class="container-fluid row my-5 d-flex justify-content-center">
        ...
        <div class="card col-lg-6 border-0 polaroid">
          ...
          <img class="card-img-top" src="assets\img\imgTrabajo\atletismo01.jpg" alt="Carrera en pista de atletismo por un grupo de niños" style="width:100%">
        ...
        <div class="card col-lg-6 border-0 polaroid">
          ...
          <img class="card-img-top" src="assets\img\imgTrabajo\tenis.jpg" alt="Chica en clase de tenis" style="width:100%">
          <div class="card-body">
