    ...
    <nav class="navbar navbar-expand-lg bg-primary text-uppercase fixed-top" id="mainNav">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ms-auto d-flex align-items-center">
                ...
                <li class="nav-item mx-0 mx-lg-1"><a class="nav-link <?php if ($CURRENT_PAGE == "Actividades") { ?>active<?php } ?> py-3 px-0 px-lg-3 rounded" href="about.php">Actividades</a></li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-primary text-uppercase border-0 " aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item text-white" href="#">Piscina</a>
                        <a class="dropdown-item text-white" href="#">Gimnasio</a>
                        <a class="dropdown-item text-white" href="#">Pista de atletismo</a>
                        <a class="dropdown-item text-white" href="#">Dojo</a>
                    </div>
