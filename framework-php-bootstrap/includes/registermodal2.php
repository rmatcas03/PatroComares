          ...
          <div class="container ">
            ...
            <div class='row-form text-center'>
              <div class='column-form '>
                ...
                <input type="email" placeholder="Introduce Email" name="email" value="" readonly>
                <div>
              ...
              <div>
                ...
                <input type="text" name="tlf" value="" readonly>
              </div>
              </div>
            ...
            <div class='column-form '>
                ...
                <input type="pass" placeholder="Introduce contraseña" name="pass" value="" readonly>
                <div>
                  <label for="confContr"><b>Confirmar Contraseña</b></label>
                  <input type="text" name="confContr" value="" readonly>
                </div>
            <div class="text-center">
              <label>
